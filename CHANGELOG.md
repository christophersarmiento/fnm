...
- [`2aacfbc`](https://github.com/Schniz/fnm/commit/2aacfbc91d3c8ce71f60b3fb6fe861e4a5dc8563) Thanks [@christophersarmiento](https://github.com/christophersarmiento)! - Grant the `release` workflow `contents: write` and `pull-requests: write` permissions so the changesets action can push the "Version Packages" branch and open its PR.
